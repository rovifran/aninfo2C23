...
def fosforitos(puntos, offset_jugador):
    if puntos > 25:
        ...
        PARTIDASURF.blit(fosforos_5,
                         (SCREEN_WIDTH / 20 + offset_jugador, SCREEN_HEIGHT / 20 + PICTURE_SIZE + 50 + 225 + 25))
        PARTIDASURF.blit(fosforos_5,
                         (SCREEN_WIDTH / 20 + offset_jugador, SCREEN_HEIGHT / 20 + PICTURE_SIZE + 50 + 300 + 25))
        PARTIDASURF.blit(fosforos[puntos % 5 - 1],
                         (SCREEN_WIDTH / 20 + offset_jugador, SCREEN_HEIGHT / 20 + PICTURE_SIZE + 50 + 375 + 25))
    elif puntos > 20:
        PARTIDASURF.blit(fosforos_5, (SCREEN_WIDTH / 20 + offset_jugador, SCREEN_HEIGHT / 20 + PICTURE_SIZE + 50))
        PARTIDASURF.blit(fosforos_5, (SCREEN_WIDTH / 20 + offset_jugador, SCREEN_HEIGHT / 20 + PICTURE_SIZE + 50 + 75))
        PARTIDASURF.blit(fosforos_5, (SCREEN_WIDTH / 20 + offset_jugador, SCREEN_HEIGHT / 20 + PICTURE_SIZE + 50 + 150))
        ...
        PARTIDASURF.blit(fosforos_5, (SCREEN_WIDTH / 20 + offset_jugador, SCREEN_HEIGHT / 20 + PICTURE_SIZE + 50 + 75))
        PARTIDASURF.blit(fosforos[puntos % 5 - 1],
                         (SCREEN_WIDTH / 20 + offset_jugador, SCREEN_HEIGHT / 20 + PICTURE_SIZE + 50 + 150))
    elif puntos > 5:
        PARTIDASURF.blit(fosforos_5, (SCREEN_WIDTH / 20 + offset_jugador, SCREEN_HEIGHT / 20 + PICTURE_SIZE + 50))
        PARTIDASURF.blit(fosforos[puntos % 5 - 1],
                         (SCREEN_WIDTH / 20 + offset_jugador, SCREEN_HEIGHT / 20 + PICTURE_SIZE + 50 + 75))
    else:
        PARTIDASURF.blit(fosforos[puntos % 5 - 1],
                         (SCREEN_WIDTH / 20 + offset_jugador, SCREEN_HEIGHT / 20 + PICTURE_SIZE + 50))
...
def puntos_display(jugador_1, jugador_2):
    ...
    # Cuadrados
    jugador_rect = pygame.draw.rect(PARTIDASURF, BLACK,
                                    (SCREEN_WIDTH / 20, SCREEN_HEIGHT / 20, PICTURE_SIZE, PICTURE_SIZE), 3, 10)
    ...
    riedel_rect = pygame.draw.rect(PARTIDASURF, BLACK, (
    SCREEN_WIDTH / 20 + PICTURE_SIZE + 20, SCREEN_HEIGHT / 20, PICTURE_SIZE, PICTURE_SIZE), 3, 10)
    ...
    # Nombres
    PARTIDASURF.blit(button_font.render(f'{jugador_1}', True, BLACK),
                     (SCREEN_WIDTH / 20, SCREEN_HEIGHT / 20 + PICTURE_SIZE + 20))
    PARTIDASURF.blit(button_font.render(f'{jugador_2}', True, BLACK),
                     (SCREEN_WIDTH / 20 + PICTURE_SIZE + 20, SCREEN_HEIGHT / 20 + PICTURE_SIZE + 20))
...
def botones_display(truco_actual, se_puede_cantar_truco, se_puede_cantar_tantos, falta_envido_cantado,
                    real_envido_cantado, envido_cantado):
    # Display y anuncio
...
def mostrar_cartel_turno(jugador_actual):
    ...
    text_coords = (turno_actual_cartel.x + turno_actual_cartel.width / 2 - 90,
                   turno_actual_cartel.y + turno_actual_cartel.height / 2 - 10)
...
def mostrar_opciones_truco(partida):
    if partida.truco_actual != None:
        ...
        pygame.draw.rect(PARTIDASURF, BLUE, (
        SCREEN_WIDTH / 2 - BUTTON_WIDTH / 2 - 2 * BUTTON_WIDTH - 10, SCREEN_HEIGHT / 25 + 10 - 10,
        BUTTON_WIDTH * 5 + 20, BUTTON_HEIGHT + 20), border_radius=10)
        pygame.draw.rect(PARTIDASURF, BLACK, (
        SCREEN_WIDTH / 2 - BUTTON_WIDTH / 2 - 2 * BUTTON_WIDTH - 10, SCREEN_HEIGHT / 25 + 10 - 10,
        BUTTON_WIDTH * 5 + 20, BUTTON_HEIGHT + 20), 3, 10)
...
def message_display(mensaje, tamanio=60, sleep_t=0.75, cartel_t=0):
    ...
    pygame.draw.rect(PARTIDASURF, WHITE, (
    SCREEN_WIDTH / 2 - 200 - cartel_t, SCREEN_HEIGHT / 2 - 50 - cartel_t, 400 + cartel_t * 2, 100 + cartel_t * 2),
                     border_radius=10)
...
def init_partida(nombre_p1, nombre_p2, max_puntos):
    ...
    partida, mesa, p1, p2 = iniciar_mano(nombre_p1, nombre_p2,
                                         max_puntos)  # WIP se puede pasar a clase para no tener todo al aire
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            botones_display(truco_actual_lindo, se_puede_cantar_truco, se_puede_cantar_tantos, falta_envido_cantado,
                            real_envido_cantado, envido_cantado)
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                # Check si toco boton
                if truco_button_pos.collidepoint(
                        event.pos) and se_puede_cantar_truco and jugador_actual.canto_truco_actual != "-":
                ...
                elif envido_button_pos.collidepoint(
                        event.pos) and se_puede_cantar_tantos and not falta_envido_cantado and not real_envido_cantado and not envido_envido_cantado:
                    envido_cantado = True
                    partida.cantar_envido("ENVIDO")

                elif real_envido_button_pos.collidepoint(
                        event.pos) and se_puede_cantar_tantos and not falta_envido_cantado and not real_envido_cantado:
                    envido_cantado = True
                    real_envido_cantado = True
                    partida.cantar_envido("REALENVIDO")

                elif falta_envido_button_pos.collidepoint(
                        event.pos) and se_puede_cantar_tantos and not falta_envido_cantado:
                    envido_cantado = True
                ...
                if se_puede_cantar_tantos and envido_cantado:
                    if envido_quiero_button_pos.collidepoint(event.pos) and partida.envido_actual != None:
                        ...
                        se_puede_cantar_tantos = False
                        message_display(
                            "Gano el envido " + res.ganador.personaje + " con " + str(res.puntos_ganador) + " puntos",
                            20, sleep_t=1.3, cartel_t=30)
                        message_display("Perdio el envido " + res.perdedor.personaje + " con " + str(
                            res.puntos_perdedor) + " puntos", 20, sleep_t=1.3, cartel_t=30)
                    ...
                    elif envido_envido_button_pos.collidepoint(
                            event.pos) and partida.envido_actual != None and not falta_envido_cantado and not real_envido_cantado and not envido_envido_cantado:

                        envido_envido_cantado = True
                        partida.cantar_envido("ENVIDO")

                    elif envido_real_envido_button_pos.collidepoint(
                            event.pos) and partida.envido_actual != None and not falta_envido_cantado and not real_envido_cantado:

                        real_envido_cantado = True
                        partida.envido_actual.aceptar_envido()
                        partida.cantar_envido("REALENVIDO")

                    elif envido_falta_envido_button_pos.collidepoint(
                            event.pos) and partida.envido_actual != None and not falta_envido_cantado:
                ...
                if se_canto_truco:
                    ...
                    elif truco_re_truco_button_pos.collidepoint(
                            event.pos) and jugador_actual.canto_truco_actual == "RETRUCO":
                        truco_etapas.pop()
                    ...
                    elif truco_vale_cuatro_button_pos.collidepoint(
                            event.pos) and jugador_actual.canto_truco_actual == "VALE_CUATRO":
                        jugador_actual.canto_truco_actual = "-"
                        truco_etapas.pop()
                ...
                carta_seleccionada_surf.center = (
                pygame.mouse.get_pos()[0] - offset_x, pygame.mouse.get_pos()[1] - offset_y)
