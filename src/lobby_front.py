...
jugar_como_fito = Button(150, 150, 200, 200, (255, 0, 0), "", lambda: (
sonidos_pjs["fito"].play(), screen.setPlayers("fito", "riedel"), screen.start_match()), img="fito")
jugar_como_bob = Button(400, 150, 200, 200, (255, 0, 0), "",
                        lambda: (sonidos_pjs["bob"].play(), screen.setPlayers("bob", "riedel"), screen.start_match()),
                        img="bob")
jugar_como_mariachi = Button(650, 150, 200, 200, (255, 0, 0), "", lambda: (
sonidos_pjs["mariachi"].play(), screen.setPlayers("mariachi", "riedel"), screen.start_match()), img="mariachi")
jugar_como_martu = Button(275, 400, 200, 200, (255, 0, 0), "", lambda: (
sonidos_pjs["martu"].play(), screen.setPlayers("martu", "riedel"), screen.start_match()), img="martu")
jugar_como_kim = Button(525, 400, 200, 200, (255, 0, 0), "", lambda: (
sonidos_pjs["kim-jong-un"].play(), screen.setPlayers("kim-jong-un", "riedel"), screen.start_match()), img="kim-jong-un")
...
hasta_15 = Button(100, 100, 400, 100, (0, 255, 0), "   a 15",
                  lambda: (screen.set_amt_points(15), screen.change_widgets(widgets_for_screen_3)))
hasta_30 = Button(100, 250, 400, 100, (0, 255, 0), "   a 30",
                  lambda: (screen.set_amt_points(30), screen.change_widgets(widgets_for_screen_3)))
