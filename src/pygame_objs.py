...
# Cartas
carta_en_mano_1_pos = pygame.Rect(SCREEN_WIDTH / 2 - CARD_WIDTH / 2 - CARD_WIDTH * 1, SCREEN_HEIGHT * 3 / 4, CARD_WIDTH,
                                  CARD_HEIGHT)
carta_en_mano_2_pos = pygame.Rect(SCREEN_WIDTH / 2 - CARD_WIDTH / 2, SCREEN_HEIGHT * 3 / 4, CARD_WIDTH, CARD_HEIGHT)
carta_en_mano_3_pos = pygame.Rect(SCREEN_WIDTH / 2 - CARD_WIDTH / 2 + CARD_WIDTH * (1 - 1 / 3), SCREEN_HEIGHT * 3 / 4,
...
carta_en_mano_1_pos_oponente = pygame.Rect(SCREEN_WIDTH / 2 - CARD_WIDTH / 2 - CARD_WIDTH * (2 / 3), SCREEN_HEIGHT / 25,
                                           CARD_WIDTH, CARD_HEIGHT)
carta_en_mano_2_pos_oponente = pygame.Rect(SCREEN_WIDTH / 2 - CARD_WIDTH / 2, SCREEN_HEIGHT / 25, CARD_WIDTH,
                                           CARD_HEIGHT)
carta_en_mano_3_pos_oponente = pygame.Rect(SCREEN_WIDTH / 2 - CARD_WIDTH / 2 + CARD_WIDTH * (2 / 3), SCREEN_HEIGHT / 25,
                                           CARD_WIDTH, CARD_HEIGHT)
...
carta_en_mesa_1_pos = pygame.Rect(SCREEN_WIDTH / 2 - CARD_WIDTH / 2 - CARD_WIDTH * 1.2,
                                  SCREEN_HEIGHT / 2 - CARD_HEIGHT / 2, CARD_WIDTH, CARD_HEIGHT)
carta_en_mesa_2_pos = pygame.Rect(SCREEN_WIDTH / 2 - CARD_WIDTH / 2, SCREEN_HEIGHT / 2 - CARD_HEIGHT / 2, CARD_WIDTH,
                                  CARD_HEIGHT)
carta_en_mesa_3_pos = pygame.Rect(SCREEN_WIDTH / 2 - CARD_WIDTH / 2 + CARD_WIDTH * 1.2,
                                  SCREEN_HEIGHT / 2 - CARD_HEIGHT / 2, CARD_WIDTH, CARD_HEIGHT)
...
envido_button_pos = pygame.Rect(SCREEN_WIDTH * (1 - 1 / 5) - 10, SCREEN_HEIGHT / 25 + 10 + 50, BUTTON_WIDTH,
                                BUTTON_HEIGHT)
real_envido_button_pos = pygame.Rect(SCREEN_WIDTH * (1 - 1 / 5) - 10, SCREEN_HEIGHT / 25 + 10 + 100, BUTTON_WIDTH,
                                     BUTTON_HEIGHT)
falta_envido_button_pos = pygame.Rect(SCREEN_WIDTH * (1 - 1 / 5) - 10, SCREEN_HEIGHT / 25 + 10 + 150, BUTTON_WIDTH,
                                      BUTTON_HEIGHT)
flor_button_pos = pygame.Rect(SCREEN_WIDTH * (1 - 1 / 5) - 10, SCREEN_HEIGHT / 25 + 10 + 200, BUTTON_WIDTH,
                              BUTTON_HEIGHT)
mazo_button_pos = pygame.Rect(SCREEN_WIDTH * (1 - 1 / 5) - 10, SCREEN_HEIGHT / 25 + 10 + 250, BUTTON_WIDTH,
                              BUTTON_HEIGHT)
salir_button_pos = pygame.Rect(SCREEN_WIDTH * (1 - 1 / 5) - 10, SCREEN_HEIGHT / 25 + 10 + 300, BUTTON_WIDTH,
                               BUTTON_HEIGHT)

turno_actual_cartel = pygame.Rect(SCREEN_WIDTH / 25, SCREEN_HEIGHT - BUTTON_HEIGHT, BUTTON_WIDTH * 1.6, BUTTON_HEIGHT)

# Botones Envido
envido_quiero_button_pos = pygame.Rect(SCREEN_WIDTH / 2 - BUTTON_WIDTH / 2 - 2 * BUTTON_WIDTH, SCREEN_HEIGHT / 25 + 10,
                                       BUTTON_WIDTH, BUTTON_HEIGHT)
envido_no_quiero_button_pos = pygame.Rect(SCREEN_WIDTH / 2 - BUTTON_WIDTH / 2 - BUTTON_WIDTH, SCREEN_HEIGHT / 25 + 10,
                                          BUTTON_WIDTH, BUTTON_HEIGHT)
envido_envido_button_pos = pygame.Rect(SCREEN_WIDTH / 2 - BUTTON_WIDTH / 2, SCREEN_HEIGHT / 25 + 10, BUTTON_WIDTH,
                                       BUTTON_HEIGHT)
envido_real_envido_button_pos = pygame.Rect(SCREEN_WIDTH / 2 - BUTTON_WIDTH / 2 + BUTTON_WIDTH, SCREEN_HEIGHT / 25 + 10,
                                            BUTTON_WIDTH, BUTTON_HEIGHT)
envido_falta_envido_button_pos = pygame.Rect(SCREEN_WIDTH / 2 - BUTTON_WIDTH / 2 + 2 * BUTTON_WIDTH,
                                             SCREEN_HEIGHT / 25 + 10, BUTTON_WIDTH, BUTTON_HEIGHT)

truco_quiero_button_pos = pygame.Rect(SCREEN_WIDTH / 2 - BUTTON_WIDTH / 2 - 3 * BUTTON_WIDTH / 2,
                                      SCREEN_HEIGHT / 25 + 10, BUTTON_WIDTH, BUTTON_HEIGHT)
truco_no_quiero_button_pos = pygame.Rect(SCREEN_WIDTH / 2 - BUTTON_WIDTH / 2 - BUTTON_WIDTH / 2,
                                         SCREEN_HEIGHT / 25 + 10, BUTTON_WIDTH, BUTTON_HEIGHT)
truco_re_truco_button_pos = pygame.Rect(SCREEN_WIDTH / 2 - BUTTON_WIDTH / 2 + BUTTON_WIDTH / 2, SCREEN_HEIGHT / 25 + 10,
                                        BUTTON_WIDTH, BUTTON_HEIGHT)
truco_vale_cuatro_button_pos = pygame.Rect(SCREEN_WIDTH / 2 - BUTTON_WIDTH / 2 + 3 * BUTTON_WIDTH / 2,
                                           SCREEN_HEIGHT / 25 + 10, BUTTON_WIDTH, BUTTON_HEIGHT)
# Cartel de avisos
cartel_avisos = pygame.Rect(SCREEN_WIDTH / 2 - CARTEL_AVISOS_SIZE / 2, SCREEN_HEIGHT / 2 - CARTEL_AVISOS_SIZE / 2,
